package com.yice.edu.cn.gateway.filter.pcd;
 ...
 */
@Component
public class PcdLoginFilter extends AbstractGatewayFilterFactory {
    Pattern pattern = Pattern.compile("^/pcd/login|^/pcd$|\\..*|.*/swagger.*|.*/webjars.*|.*/v2/api-docs.*$");
   @Override
        ...
        return (exchange, chain) -> {
            ...
            if(tokens==null||tokens.size()==0){
                ...
                if(claims!=null){
                    ...
                    request=exchange.getRequest().mutate().header(Constant.Redis.PCD_ACCOUNT_ID_HEADER, id).build();
                }
