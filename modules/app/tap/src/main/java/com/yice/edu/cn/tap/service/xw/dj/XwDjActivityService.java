...
import com.yice.edu.cn.tap.feignClient.xw.dj.XwDjActivityFeign;
...
public class XwDjActivityService {
    ...
    */
    public List<XwDjActivity> findXwDjActivityListByCondition(XwDjActivity xwDjActivity) {
        List<XwDjActivity> xwDjActivityList = xwDjActivityFeign.findXwDjActivityTeacherListByCondition (xwDjActivity);
    ...
    public long findXwDjActivityCountByCondition(XwDjActivity xwDjActivity) {
        return xwDjActivityFeign.findXwDjActivityTeacherCountByCondition(xwDjActivity);
    }
