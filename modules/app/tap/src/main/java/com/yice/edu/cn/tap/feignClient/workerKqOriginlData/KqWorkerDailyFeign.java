package com.yice.edu.cn.tap.feignClient.workerKqOriginlData;
...
import com.yice.edu.cn.common.pojo.xw.workerKq.KqWorkerManageNow;
...
public interface KqWorkerDailyFeign {
    ...
    KqWorkerDaily getInClock(KqWorkerDaily kqWorkerDaily);
    @PostMapping("/isKqGroupManager")
    List<String> isKqGroupManage(KqWorkerDaily kqWorkerDaily);
    @PostMapping("/findWorkerMonthStatistic")
    KqWorkerMonth findWorkerMonthStatistic( KqWorkerMonth kqWorkerMonth);
    @PostMapping("/findWorkerManageMonthStatistic")
    KqWorkerManageMonth findWorkerManageMonthStatistic(KqWorkerMonth kqWorkerMonth);
    @PostMapping("/findWorkerManageNowStatistic")
    KqWorkerManageNow findWorkerManageNowStatistic(KqWorkerMonth kqWorkerMonth);
    @PostMapping("/findWorkerManageNotInManStatistic")
    List<KqWorkerDaily> findWorkerManageNotInManStatistic(KqWorkerMonth kqWorkerMonth);
    ...
    Double findTodayCheckRate( TeacherAttendance attendance );
}
