...
public interface MesInstitutionAuditFeign {
    ...
    @PostMapping("/lookMesInstitutionAuditByIdAndRecordId")
    Map lookMesInstitutionAuditByIdAndRecordId(MesInstitutionAudit mesInstitutionAudit);



    @PostMapping("/saveState")
    MesInstitutionAudit saveState(MesInstitutionAudit mesInstitutionAudit);
}
