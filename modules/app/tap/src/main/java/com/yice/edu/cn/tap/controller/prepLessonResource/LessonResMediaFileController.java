...
import com.yice.edu.cn.tap.service.prepLessonResource.LessonResMediaFileService;
...
@Api(value = "/lessonResMediaFile",description = "多媒体文件模块")
...
*/
    ...
    @ApiOperation(value = "多媒体文件查看次数加1，要传入文件id", notes = "返回响应对象")
