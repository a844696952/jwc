package com.yice.edu.cn.tap.controller.exam.paperShare;
...
import com.yice.edu.cn.tap.service.exam.PaperShareService;
...
@Api(value = "/paperShare",description = "模块")
public class PaperShareController {
    ...
    public ResponseJson uploadSharePaper(@PathVariable("paperId")String paperId){
        ...
        paper.setNumbers(null);
        paper.setCurrentType(null);
        paper.setExamineeInfo(null);
        paper.setMainTitle(null);
        paper.setPrecaution(null);
        paper.setPaperInfo(null);
        paper.setGutter(null);
        paper.setVersion(null);
        paper.setVolumes(null);
        paper.setScoreBox(null);
        paper.setSecretMark(null);
        paper.setPaperFormatData(null);
        paper.setPaperFormatDataTe(null);
        paper.setSubTitle(null);
        paper.setSubjectId(null);
        paper.setCreateUserId(null);
