...
import com.yice.edu.cn.tap.service.prepareLessonsNew.JySubjectMaterialExtendService;
...
public class JySubjectMaterialExtendController {
    ...
    public ResponseJson deleteJySubjectMaterialExtend(
        ...
        if (js.getCreateUserId() == null && js.getSchoolId() == mySchoolId()) {
            //学校管理员
            jySubjectMaterialExtendService.deleteJySubjectMaterialExtend(id);
            return new ResponseJson();
        } else if (js.getCreateUserId() == myId()) {
            //教师
            jySubjectMaterialExtendService.deleteJySubjectMaterialExtend(id);
            return new ResponseJson();
        } else {
