package com.yice.edu.cn.tap.feignClient.journal;
...
@FeignClient(value="jy",path = "/journal")
public interface JournalFeign {
    ...
    List<Journal> findOtherIndexJournals(Journal journal);
    @PostMapping("/findOtherIndexJournalCount")
    long findOtherIndexJournalCount(Journal journal);
}
