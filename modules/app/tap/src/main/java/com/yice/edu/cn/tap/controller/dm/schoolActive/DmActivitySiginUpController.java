...
import com.yice.edu.cn.tap.service.dm.schoolActive.DmActivitySiginUpService;
...
public class DmActivitySiginUpController {
    ...
    @ApiOperation(value = "删除活动报名表对象")
    public ResponseJson deleteDmActivitySiginUpByCondition(
            @ApiParam(value = "活动报名表对象", required = true)
            @RequestBody DmActivitySiginUp dmActivitySiginUp){
