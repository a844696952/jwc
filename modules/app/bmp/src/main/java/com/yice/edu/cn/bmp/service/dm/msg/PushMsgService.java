...
public class PushMsgService {
    ...
    public void pushMsg(DmMsg msg){
        Push push = buildPush(Push.newBuilder(JpushApp.TAP).setAlias(msg.getTeacherId()),msg);
        stringRedisTemplate.convertAndSend(Constant.MCS_CHANEL.JPUSH_SEND_PUSH, JSONUtil.toJsonStr(push));

        Push push2 = buildPush(Push.newBuilder(JpushApp.ECC).setAlias(msg.getDmUser()),msg);
