package com.yice.edu.cn.bmp.controller.feedback;

import com.yice.edu.cn.bmp.service.feedback.FeedbackService;
...
public class FeedbackController {
    ...
    public ResponseJson saveFeedback(
        ...
        if(feedback.getSourceProblems()==null || "".equals(feedback.getSourceProblems().trim())){
            feedback.setSourceProblems("其他");
        }
        feedback.setStatus("1");//默认为未处理
