package com.yice.edu.cn.bmp.controller.journal;

import com.yice.edu.cn.bmp.service.journal.JournalService;
import com.yice.edu.cn.bmp.service.student.StudentService;
import com.yice.edu.cn.bmp.service.user.UserService;
...
public class JournalController {
    ...
    public ResponseJson saveJournal(
        ...
        journal.setUserId(student.getId());
        journal.setSchoolId(student.getSchoolId());
        journal.setFromTeacher(false);
        journal.setName(student.getName());
        journal.setPortrait(student.getImgUrl());
        journal.setClassIdEnrollYear(student.getClassesId()+","+student.getEnrollYear());
    ...
    public ResponseJson clickThumb(
            ...
            @PathVariable
            String sqId) {
        journalService.clickThumb(sqId, myStudentId());
        return new ResponseJson();
    }
