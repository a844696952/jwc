...
import com.yice.edu.cn.bmp.feignClient.parentMsg.MyClassCardFeign;
import com.yice.edu.cn.bmp.feignClient.parentMsg.ParentmsgFeign;
...
public class ParentmsgService {
    ...
    @Autowired
    private MyClassCardFeign myClassCardFeign;
    ...
    public DmClassCard findOneDmClassCardByCondition(DmClassCard dmClassCard){
        return this.myClassCardFeign.findOneDmClassCardByCondition(dmClassCard);
    }

    public Student findStudentById(String id){
        return this.myStudentFeign.findStudentById(id);
    }
}
