...
import com.yice.edu.cn.common.pojo.jy.courseware.FileType;
import com.yice.edu.cn.common.pojo.jy.courseware.ResType;
import com.yice.edu.cn.ewb.feignClient.courseware.CourseResFeign;
import com.yice.edu.cn.ewb.feignClient.courseware.CourseWareFeign;
...
public class CourseWareService {
    ...
    public CourseRes saveCourseWareAndRes(CourseWare ware) {
        ...
        courseRes.setFileType(FileType.PPT);
        ...
        if(StrUtil.isEmpty(ware.getResoucesId())){
            courseRes =courseResFeign.saveCourseRes(courseRes);
        }else {
            courseRes.setId(ware.getResoucesId());
    ...
    public CourseWare findRecentlyCourseWare(CourseWare courseWare) {
        return courseWareFeign.findRecentlyCourseWare(courseWare);
    }
}
