...
import com.yice.edu.cn.ewb.service.courseware.CourseResService;
...
//        }
    ...
    public ResponseJson mvs(
        ...
        cr.setLv2(courseRes.getLv2());
        cr.setLv3(courseRes.getLv3());
        cr.setLv4(courseRes.getLv4());
    ...
    @ApiOperation(value = "查找最新的课件资源")
    @PostMapping("/findLastRes")
    public ResponseJson findLastRes(@RequestBody CourseRes courseRes){
        CourseRes queryParam = new CourseRes();
        queryParam.setSchoolId(mySchoolId());
        queryParam.setTeacherId(myId());
        queryParam.setResType(courseRes.getResType());
        CourseRes result = courseResService.findLastRes(queryParam);
