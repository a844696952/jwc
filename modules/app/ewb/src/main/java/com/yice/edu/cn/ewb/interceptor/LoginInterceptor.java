package com.yice.edu.cn.ewb.interceptor;
...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    @CreateCache(name=Constant.Redis.EWB_TEACHER_CACHE)
    private Cache<String,Teacher> teacherCache;
    @CreateCache(name=Constant.Redis.EWB_STUDENT_CACHE)
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws IOException {
        String teacherId = request.getHeader(Constant.Redis.EWB_TEACHER_ID_HEADER);

        String studentId = request.getHeader(Constant.Redis.EWB_STUDENT_ID_HEADER);
