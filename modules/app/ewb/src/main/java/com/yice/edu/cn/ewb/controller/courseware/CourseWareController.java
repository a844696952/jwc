...
import com.yice.edu.cn.ewb.service.courseware.CourseWareService;
...
public class CourseWareController {
    ...
    @GetMapping("/findRecentlyCourseWare")
    @ApiOperation(value = "查询最近的一个课件", notes = "返回响应对象", response=CourseWare.class)
    public ResponseJson findRecentlyCourseWare(){
        CourseWare courseWare = new CourseWare();
        courseWare.setSchoolId(mySchoolId());
        courseWare.setTeacherId(myId());
        CourseWare ware=courseWareService.findRecentlyCourseWare(courseWare);
        return new ResponseJson(ware);
    }
