...
public class RecordingConfig {
  public RecordingConfig() {
    ...
    mixedVideoAudio = MIXED_AV_CODEC_TYPE.MIXED_AV_CODEC_V2;

    mixResolution = CloudCourseCommon.mixResolution;
    decryptionMode = "";
    secret = "";
    appliteDir = CloudCourseCommon.appliteDir;
    recordFileRootDir = CloudCourseCommon.recordFileRootDir;
    cfgFilePath = "";
    proxyServer = "";
    defaultUserBgPath = "";
    defaultVideoBgPath = "";

    lowUdpPort = 4010;//40000;
    highUdpPort = 40020;//40004;
    idleLimitSec = 300;
    captureInterval = 5;
    triggerMode = 0;
  ...
  /** Sets the video decoding format. See {@link io.io.agora.recording.common.Common#VIDEO_FORMAT_TYPE VIDEO_FORMAT_TYPE}.
   * 
   * @note When {@link io.io.agora.recording.common.Common#VIDEO_FORMAT_TYPE VIDEO_FORMAT_TYPE} = 1, 2, 3 or 4, {@link io.agora.recording.common.RecordingConfig#isMixingEnabled isMixingEnabled} cannot be set as true.
   */
  ...
  /** Sets the audio decoding format. See {@link io.io.agora.recording.common.Common#AUDIO_FORMAT_TYPE AUDIO_FORMAT_TYPE}.
   *
   * @note When {@link io.io.agora.recording.common.Common#AUDIO_FORMAT_TYPE AUDIO_FORMAT_TYPE} = 1, 2 or 3, {@link io.agora.recording.common.RecordingConfig#isMixingEnabled isMixingEnabled} cannot be set as true.
   */
  ...
  /** Sets the channel mode. See {@link io.io.agora.recording.common.Common#CHANNEL_PROFILE_TYPE CHANNEL_PROFILE_TYPE}. */
   ...
   * mode (high stream by default). See {@link io.io.agora.recording.common.Common#REMOTE_VIDEO_STREAM_TYPE REMOTE_VIDEO_STREAM_TYPE}.
   */
