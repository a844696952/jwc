...
public interface RecordingEventHandler {
     ...
     *
     * @param reason The reasons why the recording app leaves the channel. See {@link io.io.agora.recording.common.Common#LEAVE_PATH_CODE LEAVE_PATH_CODE}.
     */
     ...
     *
     * @param error {@link io.io.agora.recording.common.Common#ERROR_CODE_TYPE Error codes}.
     * @param stat_code {@link io.io.agora.recording.common.Common#STAT_CODE_TYPE State codes}.
     */
     ...
     *
     * @param warn {@link io.io.agora.recording.common.Common#WARN_CODE_TYPE Warning codes}.
     */
     ...
     *
     * @param uid User ID of the user.
     * @param reason The rerasons why the user leaves the channel or goes offline. See {@link io.io.agora.recording.common.Common#USER_OFFLINE_REASON_TYPE USER_OFFLINE_REASON_TYPE}.
     */
  ...
  void onActiveSpeaker(long uid);
     ...
     * @param frame Received raw audio data in PCM or AAC format. See {@link io.io.agora.recording.common.Common.AudioFrame AudioFrame}.
     */
     ...
     *  <li>2: JPEG</li>
     * </ul>
     * @param frame Received video data in YUV, H.264, or JPEG format. See {@link io.io.agora.recording.common.Common.VideoFrame VideoFrame}.
     ...
     *
     * @param infos    An array containing the user ID and volume information for each speaker. For more information, see {@link io.io.agora.recording.common.Common#AudioVolumeInfo AudioVolumeInfo}.
     */
