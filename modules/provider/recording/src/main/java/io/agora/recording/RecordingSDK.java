...
import io.agora.recording.common.LibLoader;
...
public class RecordingSDK {
  ...
  private long nativeObjectHandle = 0;
	...
	static {
		...
		LibLoader.loadLib("lib/librecording.so");
	}
  ...
  public boolean leaveChannel(long nativeHandle) {
	 ...
	 * @param nativeHandle The recording engine.
	 *
	 * @param layout Layout setting. See {@link io.io.agora.recording.common.Common.VideoMixingLayout VideoMixingLayout}.
