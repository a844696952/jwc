...
public class Common{
  ...
  public class AudioFrame {
    ...
    /** If type is AUDIO_FRAME_RAW_PCM, then PCM field points to PCM format audio data, AAC should not be used. See the structure of {@link io.io.agora.recording.common.Common#AudioPcmFrame AudioPcmFrame}. */
    public AudioPcmFrame pcm;
    /** If type is AUDIO_FRAME_AAC, then AAC field points to AAC format audio data, PCM should not be used. See the structure of {@link io.io.agora.recording.common.Common#AudioAacFrame AudioAacFrame}. */
  ...
  public class VideoFrame {
    /** If VideoFrame is in YUV format, then YUV points to video data in YUV format, H.264 and JPG fields should not be used. See {@link io.io.agora.recording.common.Common#VideoYuvFrame VideoYuvFrame}. */
    public VideoYuvFrame yuv;
    /** If VideoFrame is in H.264 format, then H.264 points to video data in H.264 format, YUV and JPG fields should not be used. See {@link io.io.agora.recording.common.Common#VideoH264Frame VideoH264Frame}. */
    public VideoH264Frame h264;
    /** If VideoFrame is in JPG format, then JPG points to video data in JPG format, YUV and H.264 fields should not be used. See {@link io.io.agora.recording.common.Common#VideoJpgFrame VideoJpgFrame}. */
