...
import com.yice.edu.cn.dm.service.msg.TeacherReceiveMsgService;
...
@RestController
@RequestMapping("/teacherReceiveMsg")
@Api(value = "/receiveMsg",description = "消息接收表模块")
public class TeacherReceiveMsgController {
    @Autowired
    private TeacherReceiveMsgService receiveMsgService;

    @GetMapping("/findReceiveMsgById/{id}")
    @ApiOperation(value = "通过id查找消息接收表", notes = "返回消息接收表对象")
    public TeacherReceiveMsg findReceiveMsgById(
    ...
    public TeacherReceiveMsg saveReceiveMsg(
    ...
    public List<TeacherReceiveMsg> findReceiveMsgListByCondition(
    ...
    public TeacherReceiveMsg findOneReceiveMsgByCondition(
            @ApiParam(value = "消息接收表对象")
            @RequestBody TeacherReceiveMsg receiveMsg){
    ...
    public void batchSave(
            @ApiParam(value = "消息接收表对象")
            @RequestBody List<TeacherReceiveMsg> list){
