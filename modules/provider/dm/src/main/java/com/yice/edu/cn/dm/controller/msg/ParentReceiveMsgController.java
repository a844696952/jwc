...
import com.yice.edu.cn.dm.service.msg.ParentReceiveMsgService;
...
@RestController
@RequestMapping("/parentReceiveMsg")
@Api(value = "/receiveMsg",description = "消息接收表模块")
public class ParentReceiveMsgController {
    @Autowired
    private ParentReceiveMsgService receiveMsgService;

    @GetMapping("/findReceiveMsgById/{id}")
    @ApiOperation(value = "通过id查找消息接收表", notes = "返回消息接收表对象")
    public ParentReceiveMsg findReceiveMsgById(
    ...
    public ParentReceiveMsg saveReceiveMsg(
    ...
    public List<ParentReceiveMsg> findReceiveMsgListByCondition(
    ...
    public ParentReceiveMsg findOneReceiveMsgByCondition(
            @ApiParam(value = "消息接收表对象")
            @RequestBody ParentReceiveMsg receiveMsg){
    ...
    public void batchSave(
            @ApiParam(value = "消息接收表对象")
            @RequestBody List<ParentReceiveMsg> list){
