...
public class PushExample {
    ...
    protected static final String APP_KEY ="6bf85ce9fc89d3387386ce32";
    protected static final String MASTER_SECRET = "a61c9b95e8e540ffedf89045";
    ...
    public static final String REGISTRATION_ID = "1753688335901876224";
    public static final String TAG = "tag_api";
    public static long sendCount = 0;
    private static long sendTotalTime = 0;

    private static final String alias = "1753688335901876224";
...
//        PushPayload.newBuilder()
       /* PushPayload.newBuilder()
                .setMessage(Message.newBuilder().addExtra())*/



	}

	public static void testSendToAlias(){
...
//        ApacheHttpClient httpClient = new ApacheHttpClient(authCode, null, clientConfig);
    ...
    public static PushPayload buildPushObject_all_alias_alert() {
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.alert("内容吗"))
                .build();
    }
    public static PushPayload buildPushObjectAlias(){
        return PushPayload.newBuilder()
