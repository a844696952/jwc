...
@FeignClient(value="jw",contextId = "studentFamilyFeign",path = "/studentFamily")
public interface StudentFamilyFeign {
    ...
    @PostMapping("/findOneStudentFamilyByCondition")
    StudentFamily findOneStudentFamilyByCondition(StudentFamily studentFamily);
