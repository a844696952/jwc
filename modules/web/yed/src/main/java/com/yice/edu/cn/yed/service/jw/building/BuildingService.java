package com.yice.edu.cn.yed.service.jw.building;

import com.yice.edu.cn.common.pojo.jw.building.Building;
import com.yice.edu.cn.yed.feignClient.jw.building.BuildingFeign;
...
public class BuildingService {
    ...
    public List<String> findBuildingListByParentIds(List<String> list) {
        return buildingFeign.findBuildingListByParentIds(list);
    }
}
