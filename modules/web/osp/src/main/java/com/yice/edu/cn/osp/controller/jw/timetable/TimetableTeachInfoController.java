...
import com.yice.edu.cn.osp.service.jw.timetable.TimetableTeachInfoService;
...
public class TimetableTeachInfoController {
    ...
    public ResponseJson saveTimetableTeachInfo(
            ...
            @RequestBody @Validated(value=GroupOne.class) TeachInfoBo teachInfos){
    ...
    public List<ArrangeCourse> findTeachInfoCourseByJobId(@PathVariable String jobId){
