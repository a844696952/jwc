...
public class DepartmentController {
    ...
    public ResponseJson saveDepartment(
       ...
       department.setSchoolId(mySchoolId());
    ...
    public ResponseJson findSelectAndUnSelect(@PathVariable String departmentId){
        ...
        List<Teacher> all=departmentService.findAllTeacherBySchoolId(mySchoolId());
    ...
    public ResponseJson findDepartmentHaveOrNotTeacherForTree(@PathVariable boolean forDepartment,@PathVariable int personType){
        List<Department> departments=departmentService.findDepartmentHaveOrNotTeacherForTree(mySchoolId(),forDepartment,personType);
        return new ResponseJson(departments);
    }

    @PostMapping("/ignore/findDepartmentOrTeacher/{forDepartment}")
    public ResponseJson findDepartmentOrTeacher(@PathVariable boolean forDepartment,@RequestBody @NotEmpty List<String> ids){
        List<Department> departments=departmentService.findDepartmentOrTeacher(forDepartment, ids,mySchoolId());
        return new ResponseJson(departments);
    }
