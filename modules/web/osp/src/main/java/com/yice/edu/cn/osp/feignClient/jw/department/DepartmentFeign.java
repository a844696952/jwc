package com.yice.edu.cn.osp.feignClient.jw.department;
...
public interface DepartmentFeign {
    ...
    List<Department> findDepartmentTreeBySchoolId(@PathVariable("schoolId") String schoolId, @PathVariable("notEmpty") boolean notEmpty,@PathVariable("personType") int personType);
