...
import com.yice.edu.cn.osp.feignClient.xw.pcdDoc.PcdDocRevertFeign;
...
/*-------------------------------------------------generated code end,do not update-----------------------------------------------------------*/
    ...
    public PcdDocRevert findAndUpdatePcdDocRevertById(String id){
        return pcdDocRevertFeign.findAndUpdatePcdDocRevertById(id);
    }
}
