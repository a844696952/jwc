...
import com.yice.edu.cn.osp.service.jw.appIndex.AppIndexService;
...
public class AppIndexController {
    ...
    @GetMapping("/findAppIndexListForSchool")
    public ResponseJson findAppIndexListForSchool(){
        List<AppIndex> list=appIndexService.findAppIndexListForSchool(mySchoolId());
