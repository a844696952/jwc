package com.yice.edu.cn.osp.controller.jy.correspondence;
...
public class CorrespondenceController {
    ...
    @ApiOperation(value = "无需传参直接调用查出当前老师所教的班级或传入姓名(name)或学号(studentCode)查询班级", notes = "返回当前教师对应所教的班级(学生通讯录)")
    ...
    @ApiOperation(value = "参数为班级classesId且不为空当模糊查询的时候只要输入姓名(name)或学号(studentCode)就行", notes = "返回当前点击班级，教师对应所教的学生信息和数量(学生通讯录)")
