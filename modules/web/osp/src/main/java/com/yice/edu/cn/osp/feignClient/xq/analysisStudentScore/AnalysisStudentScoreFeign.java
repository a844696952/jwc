package com.yice.edu.cn.osp.feignClient.xq.analysisStudentScore;
...
public interface AnalysisStudentScoreFeign {
    ...
    List<AnalysisStudentScore> findStudentExamScoreListByCondition(AnalysisStudentScore analysisStudentScore);
    @PostMapping("/findStudentScoresCountByCondition")
    long findStudentScoresCountByCondition(AnalysisStudentScore analysisStudentScore);
}
