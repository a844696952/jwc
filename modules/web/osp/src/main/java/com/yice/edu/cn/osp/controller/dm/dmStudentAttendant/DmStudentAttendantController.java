package com.yice.edu.cn.osp.controller.dm.dmStudentAttendant;
...
import com.yice.edu.cn.osp.service.dm.dmStudentAttendant.DmStudentAttendantService;
...
public class DmStudentAttendantController {
    ...
    /**================值班日期查询==start===============**/
    @GetMapping("/findAttendantType")
    @ApiOperation(value = "值班日期查询",response = Dd.class,responseContainer = "List")
    public ResponseJson findAttendantType(){
        Dd dd = new Dd();
