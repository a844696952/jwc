...
@RestController
@RequestMapping("/YcVerifaceDeviceBoundGroup")
@Api(value = "/YcVerifaceDeviceBoundGroup",description = "亿策人脸识别设备绑定分组关联表模块")
public class YcVerifaceDeviceBoundGroupController {
    @Autowired
