package com.yice.edu.cn.osp.controller.wb.groupManage;
...
import com.yice.edu.cn.osp.service.wb.groupManage.GroupManageService;
...
public class GroupManageController {
    ...
    public ResponseJson saveGroupManage(
        ...
        int count = groupManageService.saveGroupManage(groupManage);
    ...
    public ResponseJson updateGroupManage(
            ...
            @RequestBody GroupManage groupManage){
        int count = groupManageService.updateGroupManage(groupManage);
        return new ResponseJson(count);
    }
    ...
    public ResponseJson findGroupManagesByCondition(
            ...
            @Validated
            @RequestBody GroupManage groupManage){
        if(ObjectUtil.isNotNull(groupManage.getGroupName())){
