package com.yice.edu.cn.osp.controller.xq.clCustomMaterial;
...
@RestController
@RequestMapping("/clCustomMaterialDataXq")
@Api(value = "/clCustomMaterialDataXq",description = "模块")
public class ClCustomMaterialDataXqController {
    @Autowired
    ...
    public ResponseJson findClCustomMaterialDatasByCondition(
            ...
            @RequestBody ClCustomMaterialData clCustomMaterialData){
        clCustomMaterialData.setSchoolId(LoginInterceptor.mySchoolId());
        clCustomMaterialData.setType(2);
