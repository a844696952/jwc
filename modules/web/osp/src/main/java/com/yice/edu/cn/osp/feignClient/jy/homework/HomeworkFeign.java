...
public interface HomeworkFeign {
    ...
    Map<String, Object> findHomeworksByConditionDetail(Homework homework);
    ...
    List<Map<String, Object>> findOneStudentKnoledgeContext(Homework homework);
    ...
    Map<String,Object> findWrongtopicInfo(Homework homework);
    @PostMapping("/findOneStudentKnoledgeContextCount")
    Integer findOneStudentKnoledgeContextCount(Homework homework);
    ...
    Integer findKnowlegAllMoreDetailByConditionCount(Homework homework);
}
