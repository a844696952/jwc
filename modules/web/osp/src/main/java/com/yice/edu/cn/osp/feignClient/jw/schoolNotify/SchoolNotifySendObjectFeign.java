...
@FeignClient(value="jw",contextId = "schoolNotifySendObjectFeign",path = "/schoolNotifySendObject")
public interface SchoolNotifySendObjectFeign {
    ...
    void updateSchoolNotifySendObject1(SchoolNotifySendObject schoolNotifySendObject);
    ...
    long getSchoolNotifyReadDetailCount(SchoolNotifySendObject schoolNotifySendObject);
}
