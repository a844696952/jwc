package com.yice.edu.cn.osp.controller.xw.clCustomMaterial;
...
@RestController
@RequestMapping("/clCustomMaterialDataXw")
@Api(value = "/clCustomMaterialDataXw",description = "模块")
public class ClCustomMaterialDataXwController {
    @Autowired
    ...
    public ResponseJson findClCustomMaterialDatasByCondition(
            ...
            @RequestBody ClCustomMaterialData clCustomMaterialData){
        clCustomMaterialData.setSchoolId(LoginInterceptor.mySchoolId());
        clCustomMaterialData.setType(1);
    ...
    public ResponseJson findSchoolYears(){
        List<SchoolYear> schoolYears = schoolYearService.findSchoolYears(LoginInterceptor.mySchoolId());
        return new ResponseJson(schoolYears);
    }

    @GetMapping("/findCurSchoolYear")
    public ResponseJson findCurSchoolYear(){
        CurSchoolYear curSchoolYear = schoolYearService.findCurSchoolYear(LoginInterceptor.mySchoolId());
        return new ResponseJson(curSchoolYear);
    }
