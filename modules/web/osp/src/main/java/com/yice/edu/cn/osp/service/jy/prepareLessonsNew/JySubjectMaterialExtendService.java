package com.yice.edu.cn.osp.service.jy.prepareLessonsNew;

import com.yice.edu.cn.common.pojo.jy.prepareLessonsNew.JySubjectMaterialExtend;
import com.yice.edu.cn.osp.feignClient.jy.prepareLessonsNew.JySubjectMaterialExtendFeign;
...
/*-------------------------------------------------generated code start,do not update-----------------------------------------------------------*/
    ...
    public void updateJySubjectMaterialExtendSort(List<JySubjectMaterialExtend> jsmeList) {
        jySubjectMaterialExtendFeign.updateJySubjectMaterialExtendSort(jsmeList);
    }
}
