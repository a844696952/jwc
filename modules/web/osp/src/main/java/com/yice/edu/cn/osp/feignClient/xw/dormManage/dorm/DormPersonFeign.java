...
public interface DormPersonFeign {
    ...
    void leaveDormByClassesId(@PathVariable("classesId") String classesId);
    ...
    void adjustDormByCondition(List<DormPerson> dormPersonList);
    @PostMapping("/arrangeDorm")
    Map<String,Object> arrangeDorm(List<DormPerson> dormPersonList);
