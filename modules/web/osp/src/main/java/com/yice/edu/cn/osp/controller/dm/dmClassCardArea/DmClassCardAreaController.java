package com.yice.edu.cn.osp.controller.dm.dmClassCardArea;
...
import com.yice.edu.cn.osp.service.dm.dmClassCardArea.DmClassCardAreaService;
...
public class DmClassCardAreaController {
    ...
    public ResponseJson saveDmClassCardArea(
        ...
        dmClassCardArea.setSchoolId(mySchoolId());
    ...
    @GetMapping("/find/getBuildingSpaceTree")
