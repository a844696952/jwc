...
public class PcdSendController {
    ...
    public ResponseJson findPcdSendById(
        ...
        p.setDocId(id);
        p.setEehId(currentEehId());
        p.setCreateUserId(LoginInterceptor.currentAccount().getId());
    ...
    public ResponseJson findPcdSendsByCondition(
            ...
            @Validated
            @RequestBody PcdSend pcdSend){
        pcdSend.setEehId(currentEehId());
        pcdSend.setCreataUserId(LoginInterceptor.currentAccount().getId());
