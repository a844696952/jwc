...
/*-------------------------------------------------generated code end,do not update-----------------------------------------------------------*/
    ...
    List<PcdDocRevert> findAndUpdatePcdDocRevertById(PcdDocRevert pcdDocRevert);

    @PostMapping("findPcdDocRevertByPcdDocRevertListKong")
    List<PcdDocRevert> findPcdDocRevertByPcdDocRevertListKong(PcdDocRevert pcdDocRevert);

    @PostMapping("/findPcdDocRevertByPcdDocRevertLongKong")
    long findPcdDocRevertByPcdDocRevertLongKong(PcdDocRevert pcdDocRevert);
}
