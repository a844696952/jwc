...
*/
@Data
public class LessonResMediaFile{
    ...
    @ApiModelProperty(value = "文件下载次数",dataType = "String")
    ...
    @ApiModelProperty(value = "视频主讲人/来源",dataType = "String")
    private String speaker;
    @ApiModelProperty(value = "使用平台",dataType = "String")
    ...
    private Pager pager;
    //额外字段
    private List<LessonResMediaFile> files;
    //设置文件与章节关联
