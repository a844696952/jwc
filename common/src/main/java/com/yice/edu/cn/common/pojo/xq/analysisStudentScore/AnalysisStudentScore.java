...
@ApiModel("学生考试成绩-单科的")
@Document
public class AnalysisStudentScore{

    @ApiModelProperty(value = "主键",dataType = "String")
    private String id;
    @ApiModelProperty(value = "考试信息",dataType = "SchoolExam")
    private SchoolExam examination;
    @ApiModelProperty(value = "科目信息",dataType = "JwCourse")
    private JwCourse subject;
    @ApiModelProperty(value = "学生信息",dataType = "String")
