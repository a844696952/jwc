...
public class Pager implements Pageable {
    ...
    @ApiModelProperty(value = "指定哪个字段使用模糊查询,不需要模糊查询,请求参数里可删除该字段,多个字段使用逗号隔开")
    private String like;
    ...
    @ApiModelProperty("用于匹配数组字段")
    private ArrayMatch[] arrayMatches;
    ...
    public ArrayMatch[] getArrayMatches() {
        return arrayMatches;
    }

    public void setArrayMatches(ArrayMatch[] arrayMatches) {
        this.arrayMatches = arrayMatches;
    }
}
